...
declare function getInventory(SteamID64: string | steamID, appID: string | number, contextID: string | number, tradableOnly: boolean | undefined, SteamCommunity_Jar: any, useCache?: boolean, CacheDuration?: number, test?: boolean, useGC?: boolean): Promise<any>;
