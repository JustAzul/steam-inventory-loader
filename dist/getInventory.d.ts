...
declare function getInventory(SteamID64: string | steamID, appID: string | number, contextID: string | number, tradableOnly: boolean | undefined, SteamCommunity_Jar: CookieJar, Language: string): Promise<AzulInventoryResponse>;
