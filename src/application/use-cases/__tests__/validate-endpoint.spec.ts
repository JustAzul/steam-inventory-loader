...
describe(ValidateEndpointUseCase.name, () => {
    ...
    it('should not throw any exception for a valid endpoint', () => {
      const validateEndpointUseCase = new ValidateEndpointUseCase({ endpoint: validEndpoint });
    ...
    it('should throw UseCaseException for missing protocol', () => {
      ...
      const validateEndpointUseCase = new ValidateEndpointUseCase({ endpoint: invalidEndpoint });
